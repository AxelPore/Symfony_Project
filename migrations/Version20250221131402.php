 ...
 */
final class Version20250221131402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, img_link VARCHAR(255) NOT NULL, selling_date_time DATETIME NOT NULL, price NUMERIC(2, 5) NOT NULL, description VARCHAR(255) DEFAULT NULL)');
