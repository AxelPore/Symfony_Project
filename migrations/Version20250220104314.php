 ...
 */
final class Version20250220104314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN biography CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN location VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN birth_date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN social_media_links VARCHAR(255) DEFAULT NULL');
    }
